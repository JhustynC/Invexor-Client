...
@Component({
  selector: 'upgrated-form',
  templateUrl: './upgrated-form.component.html',
  standalone: true,
  imports: [ReactiveFormsModule, CommonModule, FormsModule],
  changeDetection: ChangeDetectionStrategy.OnPush,
  styleUrls: ['./upgrated-form.component.css'],
})
export class UpgratedFormComponent implements AfterViewInit {
  ...
  editableData = input<any>(undefined);
